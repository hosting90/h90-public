...
REGEX='I/O error|hard resetting link|DRDY ERR|temperature above threshold|segfault|MEMORY ERROR|dropping packet|This should not happen!! Data will be lost|task abort|No reference found at driver|connect authorization failure'
